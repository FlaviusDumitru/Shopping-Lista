...
try {
    ...
    uppdateraVaraSaknas($ch, "Nyttnamn");

    // Uppdatera med för lång vara (>30 tecken)
...
function  uppdateraForLangtNamn($curlHandle) {
    ...
    // Sätt data och skicka anrop
    $data = ['id' => $id, 'vara' => 'För lång text för att få plats i databasen, 30 tecken är allt som får plats i databasen'];
    curl_setopt ($curlHandle, CURLOPT_POST, true);
    curl_setopt ($curlHandle, CURLOPT_POSTFIELDS, $data);
